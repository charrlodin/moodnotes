      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-[101] w-[340px] rounded-2xl backdrop-blur-2xl bg-white/10 border border-white/20 shadow-2xl p-6"
          >
            {/* Header */}
